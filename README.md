...
- If you need a context from some previous session in your current one - put the prompt 'Read context/<project-name>/<task-name>.md and continue with bugfix-workflow/feature-workflow/investigation-workflow/request-workflow
